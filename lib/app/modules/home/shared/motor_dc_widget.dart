...
class MotorDcWidget extends StatefulWidget {
  final String title;
  const MotorDcWidget({Key? key, this.title = "Motor DC"}) : super(key: key);

  @override
  State<MotorDcWidget> createState() => _MotorDcWidgetState();
}

class _MotorDcWidgetState extends State<MotorDcWidget> {
